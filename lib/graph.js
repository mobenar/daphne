...
/**
 * Creates and adds multiple new nodes.
 *
 * @param {Array} nodes
 * @returns {Graph}
 */
Graph.prototype.addNewNodes = function (nodes) {

    var self = this;

    nodes.forEach(function (node) {

        self.addNode(new Node(node.id, node.label));
    });
...
/**
 * Creates and adds multiple new edges.
 *
 * @param {Array} edges
 * @returns {Graph}
 */
Graph.prototype.addNewEdges = function (edges) {
    ...
    edges.forEach(function (edge) {
        ...
        self.addEdge(new Edge(sourceNode, targetNode, edge.label));
    });
...
/**
 * Sorts all nodes and edges, from top to bottom.
 *
 * @returns {Graph}
 */
...
Graph.prototype.toString = function (format, options) {
    ...
    return format.stringify(this, options || {});
};

/**
 * Returns a new graph parsed from a string.
 *
 * @param {Object|String} format
 * @param {String} string
 * @param {Object} [options]
...
Graph.parse = function (format, string, options) {
    ...
    return format.parse(Graph, string, options || {});
};
