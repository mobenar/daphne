...
function nodeCompare(node1, node2) {
    ...
    return numberCompare(node1.incoming, node2.incoming);
};

function edgeCompare(edge1, edge2) {

    return numberCompare(edge1.sourceNode.incoming, edge2.sourceNode.incoming);
};
